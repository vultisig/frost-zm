...
#[wasm_bindgen]
pub fn frozts_sapling_build_dfvk(
    pub_key_package: &[u8],
    sapling_extras: &[u8],
...
#[wasm_bindgen]
pub fn frozts_sapling_generate_extras() -> Result<Vec<u8>, JsError> {
...
#[wasm_bindgen]
pub fn frozts_sapling_derive_keys(
    pub_key_package: &[u8],
    sapling_extras: &[u8],
...
#[wasm_bindgen]
pub fn frozts_sapling_try_decrypt_compact(
    ivk: &[u8],
    cmu: &[u8],
    ephemeral_key: &[u8],
    ciphertext: &[u8],
...
#[wasm_bindgen]
pub fn frozts_sapling_decrypt_note_full(
    ivk: &[u8],
    cmu: &[u8],
    ephemeral_key: &[u8],
    enc_ciphertext: &[u8],
...
#[wasm_bindgen]
pub fn frozts_sapling_compute_nullifier(
    dfvk_bytes: &[u8],
    note_data: &[u8],
    position: u64,
    height: u64,
...
#[wasm_bindgen]
pub fn frozts_sapling_try_output_recovery(
    ovk: &[u8],
    cv: &[u8],
    cmu: &[u8],
    ephemeral_key: &[u8],
...
#[wasm_bindgen]
pub fn frozts_sapling_build_unified_address(
    p2pkh_hash: &[u8],
    sapling_raw_addr: &[u8],
...
mod tests {
    ...
    fn test_generate_extras() {
        let extras = frozts_sapling_generate_extras().unwrap();
    ...
    fn test_derive_keys() {
        ...
        let keys = frozts_sapling_derive_keys(&pkp, &extras).unwrap();
    ...
    fn test_build_unified_address() {
        ...
        let ua = frozts_sapling_build_unified_address(&p2pkh_hash, &sapling_raw).unwrap();
