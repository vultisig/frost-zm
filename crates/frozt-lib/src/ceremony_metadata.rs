...
pub extern "C" fn frozt_keygen_metadata_create(
    birthday: u64,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_keygen_metadata_create_with_extras(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_keygen_metadata_parse(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_keygen_metadata_hash(
    metadata: Option<&go_slice>,
