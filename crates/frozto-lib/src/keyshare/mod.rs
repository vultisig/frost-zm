...
pub extern "C" fn frozto_encode_identifier(
    id: u16,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozto_decode_identifier(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozto_keypackage_identifier(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozto_pubkeypackage_verifying_key(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozto_keyshare_bundle_pack(
    key_package: Option<&go_slice>,
    pub_key_package: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozto_keyshare_bundle_birthday(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozto_keyshare_bundle_key_package(
    bundle_data: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozto_keyshare_bundle_pub_key_package(
    bundle_data: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozto_keyshare_bundle_orchard_extras(
    bundle_data: Option<&go_slice>,
    ...
    with_error_handler(|| {
        ...
        *out = tss_buffer::from_vec(b.orchard_extras);
        Ok(())
    })
}
