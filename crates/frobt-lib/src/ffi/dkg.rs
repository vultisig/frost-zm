...
pub extern "C" fn frobt_dkg_part1(
    identifier: u16,
    max_signers: u16,
    min_signers: u16,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frobt_dkg_part2(
    secret: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frobt_dkg_part3(
    secret: Handle,
    round1_packages: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frobt_derive_from_seed(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frobt_key_import_part1(
    identifier: u16,
    max_signers: u16,
    min_signers: u16,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frobt_key_import_part3(
    secret: Handle,
    round1_packages: Option<&go_slice>,
    round2_packages: Option<&go_slice>,
