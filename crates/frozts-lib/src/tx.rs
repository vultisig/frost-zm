...
pub extern "C" fn frozts_tx_builder_new(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_tx_builder_add_spend(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_tx_builder_add_output(
    builder_handle: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_tx_builder_build(
    builder_handle: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_tx_builder_complete(
    builder_handle: Handle,
...
mod tests {
    ...
    fn test_tx_builder_new_and_build_no_spends() {
        ...
        let result = frozts_tx_builder_build(
            builder_handle,
    ...
    fn test_tx_builder_invalid_extras_size() {
        ...
        let mut builder_handle = Handle::null();
        let result = frozts_tx_builder_new(
            Some(&pkp_slice), Some(&extras_slice), 2_800_000,
            Some(&mut builder_handle),
        );
    ...
    fn test_tx_builder_add_output() {
        ...
        let result = frozts_tx_builder_add_output(builder_handle, Some(&addr_slice), 100_000);
