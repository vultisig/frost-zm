...
pub extern "C" fn frozts_sapling_tree_from_state(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_sapling_tree_append(
    tree: Handle,
    cmu: Option<&go_slice>,
) -> lib_error {
    with_error_handler(|| {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_sapling_tree_witness(
    tree: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_sapling_witness_append(
    witness: Handle,
    cmu: Option<&go_slice>,
) -> lib_error {
    with_error_handler(|| {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_sapling_witness_root(
    witness: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_sapling_witness_serialize(
    witness: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_sapling_witness_deserialize(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_sapling_tree_size(
    tree_state_hex: Option<&go_slice>,
