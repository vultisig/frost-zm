...
pub extern "C" fn frozts_encode_identifier(
    id: u16,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_decode_identifier(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_keypackage_identifier(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_pubkeypackage_verifying_key(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_keyshare_bundle_pack(
    key_package: Option<&go_slice>,
    pub_key_package: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_keyshare_bundle_birthday(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_keyshare_bundle_key_package(
    bundle_data: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_keyshare_bundle_pub_key_package(
    bundle_data: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_keyshare_bundle_sapling_extras(
    bundle_data: Option<&go_slice>,
