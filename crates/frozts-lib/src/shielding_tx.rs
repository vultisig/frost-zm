...
pub extern "C" fn frozts_shielding_tx_builder_new(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_shielding_tx_builder_add_input(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_shielding_tx_builder_add_output(
    builder_handle: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_shielding_tx_builder_add_transparent_output(
    builder_handle: Handle,
    address: Option<&go_slice>,
    amount: u64,
) -> lib_error {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_shielding_tx_builder_build(
    builder_handle: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_shielding_tx_builder_complete(
    builder_handle: Handle,
