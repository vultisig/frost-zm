...
pub extern "C" fn frozts_dkg_part1(
    identifier: u16,
    max_signers: u16,
    min_signers: u16,
    ...
    with_error_handler(|| {
        ...
        let (secret, pkg_bytes) =
            frost_ceremony::dkg::dkg_part1::<J>(identifier, max_signers, min_signers)?;
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_dkg_part2(
    secret: Handle,
    ...
    with_error_handler(|| {
        ...
        let (secret2, r2_bytes) =
            frost_ceremony::dkg::dkg_part2::<J>(secret_pkg, r1_data.as_slice())?;
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozts_dkg_part3(
    secret: Handle,
    round1_packages: Option<&go_slice>,
    ...
    with_error_handler(|| {
        ...
        let (key_package, pub_key_package) =
            frost_ceremony::dkg::dkg_part3::<J>(secret_pkg, r1_data.as_slice(), r2_data.as_slice())?;
...
pub(crate) mod tests {
    ...
    pub fn run_dkg(n: u16, t: u16) -> Vec<(Vec<u8>, Vec<u8>)> {
        ...
        for i in 1..=n {
            ...
            assert_eq!(
                frozts_dkg_part1(i, n, t, Some(&mut secret), Some(&mut package)),
                lib_error::LIB_OK,
            );
