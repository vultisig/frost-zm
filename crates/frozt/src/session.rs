...
fn ser_err<E: std::fmt::Debug>(e: E) -> lib_error {
    ...
    eprintln!("frozt session serialization error: {:?}", e);
    let _ = e;
...
pub extern "C" fn frozt_dkg_setupmsg_new(
    max_signers: u16,
    min_signers: u16,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_dkg_session_from_setup(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_dkg_session_feed(
    session: Handle,
    msg: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_dkg_session_take_msg(
    session: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_dkg_session_msg_receiver(
    session: Handle,
    msg: Option<&go_slice>,
    index: u32,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_dkg_session_result(
    session: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_dkg_session_free(session: Handle) -> lib_error {
    with_error_handler(|| {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_sign_setupmsg_new(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_sign_session_from_setup(
    setup_data: Option<&go_slice>,
    my_party_name: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_sign_session_feed(
    session: Handle,
    msg: Option<&go_slice>,
    out_finished: Option<&mut i32>,
) -> lib_error {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_sign_session_take_msg(
    session: Handle,
    out_message: Option<&mut tss_buffer>,
) -> lib_error {
    with_error_handler(|| {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_sign_session_msg_receiver(
    session: Handle,
    msg: Option<&go_slice>,
    index: u32,
    out_receiver: Option<&mut tss_buffer>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_sign_session_result(
    session: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_sign_session_free(session: Handle) -> lib_error {
    with_error_handler(|| {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_reshare_setupmsg_new(
    max_signers: u16,
    min_signers: u16,
    parties_data: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_reshare_session_from_setup(
    setup_data: Option<&go_slice>,
    my_party_name: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_reshare_session_feed(
    session: Handle,
    msg: Option<&go_slice>,
    out_finished: Option<&mut i32>,
) -> lib_error {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_reshare_session_take_msg(
    session: Handle,
    out_message: Option<&mut tss_buffer>,
) -> lib_error {
    with_error_handler(|| {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_reshare_session_msg_receiver(
    session: Handle,
    msg: Option<&go_slice>,
    index: u32,
    out_receiver: Option<&mut tss_buffer>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_reshare_session_result(
    session: Handle,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_reshare_session_free(session: Handle) -> lib_error {
    with_error_handler(|| {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_key_import_setupmsg_new(
    max_signers: u16,
    min_signers: u16,
    parties_data: Option<&go_slice>,
    birthday: u64,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_key_import_session_from_setup(
    setup_data: Option<&go_slice>,
    my_party_name: Option<&go_slice>,
    out_handle: Option<&mut Handle>,
) -> lib_error {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_key_import_session_feed(
    session: Handle,
    msg: Option<&go_slice>,
    out_finished: Option<&mut i32>,
) -> lib_error {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_key_import_session_take_msg(
    session: Handle,
    out_message: Option<&mut tss_buffer>,
) -> lib_error {
    with_error_handler(|| {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_key_import_session_msg_receiver(
    session: Handle,
    msg: Option<&go_slice>,
    index: u32,
    out_receiver: Option<&mut tss_buffer>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_key_import_session_result(
    session: Handle,
    out_bundle: Option<&mut tss_buffer>,
) -> lib_error {
    with_error_handler(|| {
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn frozt_key_import_session_free(session: Handle) -> lib_error {
    with_error_handler(|| {
...
mod tests {
    ...
    fn run_n_party_dkg(n: u16, t: u16) -> Vec<Vec<u8>> {
        ...
        let sessions: Vec<_> = (1..=n).map(|i| {
            ...
            let res = frozt_dkg_session_from_setup(
        ...
        for _round in 0..50 {
            ...
            for idx in 0..n as usize {
                ...
                loop {
                    ...
                    let res = frozt_dkg_session_take_msg(*handle, Some(&mut msg_buf));
            ...
            for (sender_idx, msg) in outgoing {
                ...
                for target_idx in targets {
                    ...
                    let res = frozt_dkg_session_feed(
        ...
        for idx in 0..n as usize {
            ...
            let res = frozt_dkg_session_result(handle, Some(&mut bundle_buf));
            assert_eq!(res, lib_error::LIB_OK);
    ...
    fn test_session_sign_2x3() {
        ...
        let msg_to_sign = b"test message for frozt signing";
        ...
        for &idx in &signer_indices {
            ...
            let mut handle = Handle::null();
            let res = frozt_sign_session_from_setup(
        ...
        for _round in 0..20 {
            ...
            for idx in 0..n {
                loop {
                    let mut msg_buf = tss_buffer::empty();
                    frozt_sign_session_take_msg(sessions[idx].1, Some(&mut msg_buf));
                    let msg_bytes = msg_buf.into_vec();
                    if msg_bytes.is_empty() {
                        break;
                    }
    ...
    fn test_session_key_import_2x3() {
        ...
        let finished = run_session_loop(&sessions, frozt_key_import_session_feed, frozt_key_import_session_take_msg);
