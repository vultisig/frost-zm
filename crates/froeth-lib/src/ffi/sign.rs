...
pub extern "C" fn froeth_sign_commit(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn froeth_sign_create_package(
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn froeth_sign_aggregate(
    signing_package: Option<&go_slice>,
...
#[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
pub extern "C" fn froeth_verify_signature(
    message: Option<&go_slice>,
